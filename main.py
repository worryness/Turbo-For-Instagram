...
def turbo():
    ...
    h2 = {
        ...
        'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/573.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/573.36',
        'x-csrftoken': 'csrf',
        'x-instagram-ajax': '1',
    ...
    if r2.json()['authenticated'] == False:
        messagebox.showinfo("Damn Fag", "Invalid account or accept the gay requets on insta")
        print("$Failed")
